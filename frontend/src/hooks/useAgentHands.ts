...
/**
 * Agent rates the worker (1–5) after task completion on Celo; immutable once set on-chain.
 * @since 1.0.0
 * Score is accumulated in `workerTotalScore` and `workerRatingCount`; averaged by `useWorkerRating`.
 */
