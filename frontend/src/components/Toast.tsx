 ...
 * enqueue messages from outside the React tree (e.g. wagmi write callbacks, IPFS upload handlers on Celo).
 *
 * @since 1.0.0
 * @see toast — module-level imperative function that enqueues messages into this container
 */
